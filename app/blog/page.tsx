...
const blogPosts = [
  ...
  {
    slug: "blog13",
    title: "المعالجة الوظيفيّة العضليّة “المايوفنكشنال”",
    description: "المعالجة الوظيفية العضلية هي برنامج يتكونُ من عددٍ من التمرينات والتي تساعدك على التوقفِ عن العادات الفموية والوجهيّة التي تؤثر سلباً على صحتك وتغير في شكلك. إذ يقوم البرنامج العلاجي بإعادة تشكيل عضلات الوجه والفك والفم بحيث تبدأ بالعمل بانسجام وتوافق، ويغرس البرنامج...اقرأ المزيد",
  },
  {
    slug: "blog14",
    title: "متلازمة تململ الساقين وعلاقتها باضطراب النوم",
      image: "/blog13.jpg",
    description: "متلازمة تململ الساقين وعلاقتها باضطراب النوم   متلازمة تململ الساقين هي حالة مرضية تسيطر على المريض، حيث تتملكه رغبه ملحة في تحريك الساقين، ولاسيما عند الشعور بالتوتر أو في أوقات الاسترخاء والراحة، كما في ساعات النوم ليلا، مما يؤثر بالسلب على جودة النوم، وعدم الحصول...اقرأ المزيد",
  },
  {
    slug: "blog15",
    title: "ما هي أسباب النوم المتقطع؟ ومتي يتوجب زيارة الطبيب؟",
      image: "/blog5.jpg",
    description: "أحيانا قد يستيقظ الشخص النائم ليلا، ويجد صعوبة في معاودة النوم مرة أخرى بشكل سريع، وهو ما يلقي بظلاله على وجود خلل في الساعة البيولوجية، مما يستلزم ضرورة التعامل مع ذلك الأمر سريعا في حالة حدوثه بشكل متكرر. لذا وكبداية لابد من معرفة العامل المسبب للنوم المتقطع، ومن ثم...اقرأ المزيد",
  },
]
