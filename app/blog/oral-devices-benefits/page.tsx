        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-3xl">
          ...
          <Card className="bg-white border-0 shadow-xl rounded-2xl">
            <CardContent className="p-8">
              <img src="/dental-snore-logo.png" alt="فوائد الأجهزة الفموية" className="w-full h-64 object-cover rounded-xl mb-6" />
              <h1 className="text-3xl font-bold text-primary mb-4">فوائد الأجهزة الفموية في علاج اضطرابات النوم</h1>
              <p className="text-gray-700 text-lg mb-4">الأجهزة الفموية المخصصة تقدم حلولاً فعالة وغير جراحية لمشاكل الشخير وانقطاع التنفس أثناء النوم.</p>
