            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <Card className="bg-white hover:shadow-xl transition-shadow border-blue-200">
                <CardContent className="p-6 text-center">
                  ...
                  <a href="https://wa.me/9620797377375?text=أريد إجراء اختبار الشخير للبالغين" target="_blank" className="w-full">
              ...
              <Card className="bg-white hover:shadow-xl transition-shadow border-green-200">
                <CardContent className="p-6 text-center">
                  ...
                  <a href="https://wa.me/9620797377375?text=أريد إجراء اختبار الشخير للأطفال" target="_blank" className="w-full">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br from-blue-50 to-blue-100 aspect-video flex items-center justify-center">
                <div className="text-center">
                  ...
                  <a href="https://wa.me/9620797377375?text=أريد مشاهدة الفيديو الترحيبي" target="_blank">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-400">
                ...
                <div className="flex gap-2 mt-4">
                  <a href="https://wa.me/9620797377375" target="_blank" className="hover:text-green-400">
